function main() {
    ...
    var vertices = [
        ...
        3.4, -3.3, -1, 1, 0, 0, 0, 1, 0,   // Index:  0    
        3.4, 0, -1, 1, 0, 0, 0, 1, 0,   // Index:  1
        2.9, 0, -1, 1, 0, 0, 0, 1, 0,   // Index:  2
        2.9, -3.3, -1, 1, 0, 0, 0, 1, 0,   // Index:  3
        ...
        2.9, -3.3, 0, 1, 0.5, 0, 0, 1, 0,   // Index: 16
        3.4, -3.3, 0, 1, 0.5, 0, 0, 1, 0,   // Index: 17
        3.4, 0, 0, 1, 0.5, 0, 0, 1, 0,   // Index: 18
        2.9, 0, 0, 1, 0.5, 0, 0, 1, 0,   // Index: 19
        ...
        //Face Front-Number 1
        // Face-Back- 1       // Red
        0.5, -3.3, -1, 1, 0, 0, 0, 1, 0,
        -0.1, -3.3, -1, 1, 0, 0, 0, 1, 0,
        -0.1, 2, -1, 1, 0, 0, 0, 1, 0,
        0.5, 2, -1, 1, 0, 0, 0, 1, 0,
        // Face-Up- 1       // Yellow
        ...
        // Face-Front- 1       // Orange
        0.5, -3.3, 0, 1, 0.5, 0, 0, 1, 0,
        -0.1, -3.3, 0, 1, 0.5, 0, 0, 1, 0,
        -0.1, 2, 0, 1, 0.5, 0, 0, 1, 0,
        0.5, 2, 0, 1, 0.5, 0, 0, 1, 0,
        // Face-Front-Up-Side 1       // Orange
        0.5, -3.3, -0, 1, 0.5, 0, 0, 1, 0,
        0.9, -2.9, -0, 1, 0.5, 0, 0, 1, 0,
        0.9, -2.3, -0, 1, 0.5, 0, 0, 1, 0,
        0.5, -2.3, -0, 1, 0.5, 0, 0, 1, 0,
        // Face-Back-Up-Side 1       // Red
        0.5, -3.3, -1, 1, 0, 0, 0, 1, 0,
        0.9, -2.9, -1, 1, 0, 0, 0, 1, 0,
        0.9, -2.3, -1, 1, 0, 0, 0, 1, 0,
        0.5, -2.3, -1, 1, 0, 0, 0, 1, 0, // Vertices Total 128
        ...
        // Face-Front- I       // Orange 
        -0.5, -3.3, 0, 1, 0.5, 0, 0, 1, 0,
        -1.1, -3.3, 0, 1, 0.5, 0, 0, 1, 0,
        -1.1, 2, 0, 1, 0.5, 0, 0, 1, 0,
        -0.5, 2, 0, 1, 0.5, 0, 0, 1, 0,
        // Face-Right- I       // Green
        ...
        // Face-Back D     // Red 
        -1.5, -3.3, -1, 1, 0, 0, 0, 1, 0,
        -1.9, -3.3, -1, 1, 0, 0, 0, 1, 0,
        -1.9, 2, -1, 1, 0, 0, 0, 1, 0,
        -1.5, 2, -1, 1, 0, 0, 0, 1, 0,
        // Face-Front D     // Orange 
        -1.5, -3.3, 0, 1, 0.5, 0, 0, 1, 0,
        -1.9, -3.3, 0, 1, 0.5, 0, 0, 1, 0,
        -1.9, 2, 0, 1, 0.5, 0, 0, 1, 0,
        -1.5, 2, 0, 1, 0.5, 0, 0, 1, 0,
        ...
        -1.9, -3.1, -0, 1, 0.5, 0, 0, 1, 0,
        -2.5, -3.1, -0, 1, 0.5, 0, 0, 1, 0,
        -2.5, -3.3, -0, 1, 0.5, 0, 0, 1, 0,
        -1.9, -3.3, -0, 1, 0.5, 0, 0, 1, 0,
        // Face-Up-Front-Side-Side-Right D       // Orange
        -2.5, 2, -0, 1, 0.5, 0, 0, 1, 0,
        -2.9, 1.5, -0, 1, 0.5, 0, 0, 1, 0,
        -2.9, -2.8, -0, 1, 0.5, 0, 0, 1, 0,
        -2.5, -3.3, -0, 1, 0.5, 0, 0, 1, 0,
        // Face-Down-Front-Side-Right D       // Orange
        -1.9, 1.8, -0, 1, 0.5, 0, 0, 1, 0,
        -2.5, 1.8, -0, 1, 0.5, 0, 0, 1, 0,
        -2.5, 2, -0, 1, 0.5, 0, 0, 1, 0,
        -1.9, 2, -0, 1, 0.5, 0, 0, 1, 0,

        //Back of the D
        // Face-Up-Back-Side-Right D       // Red
        -1.9, -3.1, -1, 1, 0, 0, 0, 1, 0,
        -2.5, -3.1, -1, 1, 0, 0, 0, 1, 0,
        -2.5, -3.3, -1, 1, 0, 0, 0, 1, 0,
        -1.9, -3.3, -1, 1, 0, 0, 0, 1, 0,
        // Face-Up-Back-Side-Side-Right D       // Red
        -2.5, 2, -1, 1, 0, 0, 0, 1, 0,
        -2.9, 1.5, -1, 1, 0, 0, 0, 1, 0,
        -2.9, -2.8, -1, 1, 0, 0, 0, 1, 0,
        -2.5, -3.3, -1, 1, 0, 0, 0, 1, 0,
        // Face-Down-Back-Side-Right D       // Orange
        -1.9, 1.8, -1, 1, 0, 0, 0, 1, 0,
        -2.5, 1.8, -1, 1, 0, 0, 0, 1, 0,
        -2.5, 2, -1, 1, 0, 0, 0, 1, 0,
        -1.9, 2, -1, 1, 0, 0, 0, 1, 0,
